...
class BasicDNNModel(Classifier):
    ...
    #This function has been modified for using in EvadeDroid
    def _data_preprocess(self):
        ...
        try:            
            ...
            path = "EvadeDroid/data/features/inaccessible"        
            
            
            X_filename = os.path.join(path,"inaccessible-dataset-X.json")
            with open(X_filename,'rb') as f:
                X = json.load(f)
            
            Y_finename = os.path.join(path,"inaccessible-dataset-Y.json")
            with open(Y_finename,'rt') as f:
                Y = json.load(f)
            
            
            meta_filename = os.path.join(path,"inaccessible-dataset-meta.json")
            ...
            path = "EvadeDroid/data/features/accessible"            
            
            X_filename = os.path.join(path,"accessible-dataset-X.json")
            with open(X_filename,'rb') as f:
                X = json.load(f)
            
            Y_finename = os.path.join(path,"accessible-dataset-Y.json")
            with open(Y_finename,'rt') as f:
                Y = json.load(f)
            
            
            meta_filename = os.path.join(path,"accessible-dataset-meta.json")
            with open(meta_filename, 'rt') as f:
                meta = json.load(f)
