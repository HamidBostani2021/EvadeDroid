...
AAPT = "C:/Users/HamidBostani/AppData/Local/Android/SDK/build-tools/30.0.3/aapt.exe"  # location of the aapt binary
#AAPT = "/usr/lib/android-sdk/build-tools/27.0.1/aapt"  # location of the aapt binary
EMPTYICON = "empty.png"
