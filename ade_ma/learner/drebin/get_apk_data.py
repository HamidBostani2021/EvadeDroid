...
#Hamid import lxml.etree as etree
from xml.dom import minidom
import re
import collections

from tools import progressbar_wrapper
#Hamid from androguard.misc import AnalyzeAPK, APK
...
def GetFromXML(ApkDirectoryPath, ApkFile):
    ...
    try:
        ...
        if sys.version_info.major > 2:
            xmlstring = ""#Hamid etree.tounicode(a.xml["AndroidManifest.xml"], pretty_print=True)
        else:
            xmlstring = ""#Hamid etree.tostring(a.xml["AndroidManifest.xml"], pretty_print=True, encoding='utf-8')
